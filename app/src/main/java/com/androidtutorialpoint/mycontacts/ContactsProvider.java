...
public class ContactsProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.androidtutorialpoint.mycontacts";
 ...
 */
    ...
    public int delete(Uri uri, String s, String[] strings) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case CONTACT_ID :
            {
                ...
                database.delete(DBOpenHelper.TABLE_CONTACTS,"_id=" + id,strings);
                break;
            }
            default:
                throw new IllegalArgumentException("This is an Unknown URI " + uri);
    ...
    public int update(Uri uri, ContentValues contentValues, String s, String[] strings) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case CONTACT_ID :
            {String id = uri.getPathSegments().get(1);
                database.update(DBOpenHelper.TABLE_CONTACTS,contentValues,"_id=" + id,strings);
                break;
            }
            default:
                throw new IllegalArgumentException("This is an Unknown URI " + uri);
